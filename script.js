...
var cart=[];
//adds to the cart by clicking on the "Add to cart" button
function addtocart(a){
    cart.push({...categories[a]});
    displaycart();
}
//deletes from the cart by clicking on the delete icon 
function delElement(a){
    cart.splice(a,1);
    displaycart();
}
//displays the number of items added to the cart on th top right corner of the page
